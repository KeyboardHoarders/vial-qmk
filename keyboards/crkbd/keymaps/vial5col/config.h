...
// More Vial macro slots (default 16), and a much bigger shared buffer for
// their contents. RP2040 has plenty of flash, so trade some for macro room:
// backing size must be a multiple of the 4096-byte flash sector.
...
#define AZOTEQ_IQS5XX_TIMEOUT_MS 4
